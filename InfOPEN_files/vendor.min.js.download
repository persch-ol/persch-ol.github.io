...
/* WEBPACK VAR INJECTION */(function($) {// import Vue from 'vue';
...
var app = {
	...
	setup: {
		...
		menu: function () {
			...
			// Mobile header
			var menubtn = $('.mbl-header__icon'),
			    menuclosebtn = $('.close-btn'),
			    menuoverlay = $('.mbl-hdr__overlay'),
			    menucontent = $('.mbl-header__links');
			...
			$(document).mouseup(function (e) {
				...
				if (!content.is(e.target) && content.has(e.target).length === 0) {
					content.removeClass('show');
					$('.fltng-menu').removeClass('is-show');
				}
			});
			...
			hdr_btn.on('click', function (e) {
				...
				$('.hdr-frame__drpdwn').stop().fadeOut();
				$('#' + id + ' .hdr-frame__drpdwn').stop().fadeIn();
			});
			...
			$('.hdr-frame__chldrn-drpdwn-cntnr > a').click(function () {
				var id = $(this).data('chldrndropdown-id');
				$('.hdr-frame__chldrn-drpdwn').stop().fadeOut().parent().parent().removeClass('active');
				$('#' + id + ' .hdr-frame__chldrn-drpdwn').stop().fadeIn().parent().parent().addClass('active');
			});
			...
			$('.fltng-menu-btn').on('click', function (e) {
				// var id = $(this).data('item-id');
				// btn.removeClass('slick-current');
				// $(this).addClass('slick-current');

				// content.removeClass('show');
				$('.fltng-menu').addClass('is-show');
			});
			...
			if ($window.width() < 900) {
				app.accordion.footer($('.ftr-section-title'), 'ftr-accordion-item', 'ftr-accordion-desc');
			}

			app.accordion.genericlist($('.frm-section-title'), 'frm-accordion-item', 'frm-accordion-desc');
			app.accordion.genericsublist($('.sublist-title'), 'sublist-item', 'sublist-desc');

			var sidebarbtn = $('.sidebar-menu-btn'),
			    sidebarclose = $('.sidebar-close-btn'),
			    sidebarcontent = $('.prgrm-frm__sidebar');

			sidebarbtn.on('click', function (e) {
				sidebarcontent.addClass('is-open');
			});

			sidebarclose.on('click', function (e) {
				sidebarcontent.removeClass('is-open');
			});
			...
			// $(".fc-header-toolbar h2").attr('id', 'fc-datepicker-header').before('<input size="1" style="height: 0px; width:0px; border: 0px;" id="fc-datepicker" value="" />');
			// $("#fc-datepicker").flatpickr({
			// 	// Button: false,
			// 	//MinMonth: "+10y",
			// 	//MaxMonth: "+10y",
			// 	onChange: function() {
			// 		var d = $("#fc-datepicker").flatpickr('Validate')
			// 		console.log(d)
			// 		if (d !== null){
			...
			btn.on('click', function (e) {
				...
				// $('.hm-frame3__slider').slick("refresh");
			});
		},
		...
		homepage: function () {
			...
			$('#close-marquee').on('click', function () {
				gsap.to($('.hm-frame1__marquee'), {
					duration: .3,
					y: 100,
					opacity: 0,
					display: "none",
				...
				gsap.to($('.hm-frame1__slider .slick-dots'), {
					duration: .3,
					bottom: 30,
					ease: "expo.out"
				});
			...
			$(".hm-frame1__slider").lightGallery({
				selector: '.play-btn',
				autoplay: true
			});
			...
			$('.row2-slider').slick({
				...
				infinite: false,
				swipeToSlide: true,
				// asNavFor: '.hm-frame2__main-slider',
				responsive: [{
					breakpoint: 1324,
					settings: {
						slidesToShow: 1
			...
			$('.hm-frame2__main-slider').slick({
				...
				arrows: false,
				fade: true
				// asNavFor: '.row2-slider',
				// infinite: true
			});

			$('.row2-slider .slick-slide').on('click', function (event) {
				$('.hm-frame2__main-slider').slick('slickGoTo', $(this).data('slickIndex'));
				$('.row2-slider .slick-slide').removeClass('active');
				$('.row2-slider .slick-slide').removeClass('slick-current');
			...
			$('.hm-frame3__slider').slick({
				...
				arrows: true,
				centerMode: false,
				prevArrow: '.hm-frame3 .left-arrow',
				nextArrow: '.hm-frame3 .right-arrow',
				responsive: [{
					breakpoint: 769,
					settings: {
						slidesToShow: 3,
			...
			// var slideWidth = $('.hm-frame3__slider .hm-frame3__slider-item').width();
			// $('.hm-frame3__slider .slick-track').css( "margin-left", slideWidth + 'px' );

			$('.hm-frame3__strands').slick({
				slidesToShow: 3,
				infinite: true,
				slidesToScroll: 1,
				autoplay: false,
			...
			$('.hm-frame3__strands').removeClass("slick-current").parent().next().addClass("slick-current");

			// $('#offer2').hide();
			// $('input[name="radio-toggle"]').click(function () {
			...
			var btn = $('.toggle-btn'),
			    content = $('.hm-frame3__offer-cntnr');
			// item_close = $('.prprts-frm__btn-back');
			...
			btn.on('click', function (e) {
				...
				$(window).trigger('resize');
				$('.hm-frame3__slider').slick("refresh");
				$('.hm-frame3__strands').slick("refresh");
			});

			$('.hm-frame6__ac-slider').slick({
				slidesToShow: 1,
				slidesToScroll: 1,
				autoplay: false,
				autoplaySpeed: 2000,
			...
			let slideHeight = $('.calendar-card.head').height();
			$('.calendar-card.dates').css('height', `${slideHeight}px`);
			...
			$('.hm-frame7__slider').slick({
				...
				arrows: true,
				variableWidth: true,
				prevArrow: '.hm-frame7 .left-arrow',
				nextArrow: '.hm-frame7 .right-arrow'
			});

			function currentNews() {
				if ($(window).width() > 469) {
					gsap.to($('.hm-frame7__slider .slick-current'), {
						duration: .5,
						width: '600px',
						ease: "expo.out"
					});
			...
			$('.hm-frame7__slider').on("afterChange", function () {
				currentNews();
			});

			$('.hm-frame7__slider').on("beforeChange", function () {
				gsap.to($(this).find('.slick-slide'), {
					duration: .5,
					width: '300px',
					ease: "expo.out"
				});
			...
			// const badge = document.querySelector(".tip-badge");
			// const randomX = random(1, 10);
			// const randomY = random(1, 10);
			// const randomTime = random(3, 5);
			// const randomTime2 = random(5, 10);
			// const randomAngle = random(4, 6);
			...
			$('.hm-frame7__news--desc').each(function () {
		...
		newspage: function () {
			...
			$('.news-frame2__news--desc').each(function () {
				$(this).children().not(':first').remove();
			});

			$('.news-frame2__slider').slick({
				slidesToShow: 5,
				slidesToScroll: 1,
				autoplay: false,
				autoplaySpeed: 2000,
				...
				arrows: true,
				variableWidth: true,
				prevArrow: '.news-frame2 .left-arrow',
				nextArrow: '.news-frame2 .right-arrow'
			});

			function currentNews() {
				if ($(window).width() > 469) {
					gsap.to($('.news-frame2__slider .slick-current'), {
						duration: .5,
						width: '600px',
						ease: "expo.out"
					});
			...
			$('.news-frame2__slider').on("afterChange", function () {
				currentNews();
			});

			$('.news-frame2__slider').on("beforeChange", function () {
				gsap.to($(this).find('.slick-slide'), {
					duration: .5,
					width: '300px',
					ease: "expo.out"
		...
		search: function () {
			$('.result-frame__description').each(function () {
				// $(this).children().not(':first').remove();
			});
		},

		genericpages: function () {},
	...
	// 		app.vues.api.stylesheet = new Vue({
  ...
  **/
		...
		footer: function (button, elemHolder, hiddenElem) {
			var btn = button,
			    holder = elemHolder,
			    hidden_element = hiddenElem;

			btn.on('click', function () {
				var id = $(this).data('acc-id');
				// console.log('test')
				// $('#'+id+' .'+hidden_element).slideToggle(300);
		...
		genericlist: function (button, elemHolder, hiddenElem) {
			var btn = button,
			    holder = elemHolder,
			    hidden_element = hiddenElem;
		...
		genericsublist: function (button, elemHolder, hiddenElem) {
			var btn = button,
			    holder = elemHolder,
			    hidden_element = hiddenElem;
			...
			btn.on('click', function () {
				...
				// $('.frm-section-title i').removeClass("ion-chevron-up");
				// $('.frm-section-title i').addClass("ion-chevron-down");
				if ($('#' + id).hasClass('is-sub-active')) {
					$('#' + id + ' .' + hidden_element).slideUp(300);
					$('.' + holder).removeClass('is-sub-active');
					// $('#'+id+' .'+'frm-section-title i').removeClass("ion-chevron-up");
					// $('#'+id+' .'+'frm-section-title i').addClass("ion-chevron-down");
				} else {
					$('.' + holder).removeClass('is-sub-active');
